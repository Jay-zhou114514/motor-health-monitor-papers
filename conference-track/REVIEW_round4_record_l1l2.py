#!/usr/bin/env python3
"""Record the Layer-2 claim tightening and the Layer-1 scan in STATUS.md and the session brief."""
...
if "第二层主张按作者裁决收紧" not in status:
    ...
    print("  skip STATUS.md (already recorded)")
...
brief = sub_once(
    ...
    "按折间变异评估时预注册的 80% 稳定性标准未达到"（iForest 2/6、3σ RMS 4/6；"
    "池化口径的 6/6 降为 sensitivity）。已落到 Abstract / §3.2 / §7 / Fig.1 图注与 CLAIM_EVIDENCE_MAP 的 C9。",
